 ...
 * 在途订单的界面
 */
public class CheckOrderFragmentInTransOrderPage implements PagerNecessaryInterface, AdapterView.OnItemClickListener, View.OnClickListener {
     ...
     * 在途订单界面业务类
     */
    private CheckOrderFragmentIntransOrderPagerBiz mBiz;
    ...
    public CheckOrderFragmentInTransOrderPage(Context context) {
        try {
    ...
    private void init() {
        try {
            mBiz = new CheckOrderFragmentIntransOrderPagerBiz(this);
        } catch (Exception e) {
            ExceptionUtil.handlerException(e);
        }
    }
