 ...
 * 已完成订单业务类
 */
public class CheckPreOrderFragmentAuditOrderPagerBiz {

    private CheckPreOrderFragmentAuditOrderPage mPager;
    ...
    public CheckPreOrderFragmentAuditOrderPagerBiz(CheckPreOrderFragmentAuditOrderPage pager) {
        try {
            this.mPager = pager;
        ...
        try {
            StringRequest request = new StringRequest(Request.Method.POST, URLCostant.GetOrderPlanList, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    Logger.w(CheckPreOrderFragmentAuditOrderPagerBiz.this.getClass() + ".getOrdersDataSuccess:" + response);
                    getOrderDataSuccess(response);
                }
            }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    Logger.w(CheckPreOrderFragmentAuditOrderPagerBiz.this.getClass() + ".getOrdersDataError:" + error.toString());
