...
import com.kaidongyuan.app.kdyorder.model.TmsOrderPartyActivityBiz;
 ...
 */
public class TmsOrderPartyActivity extends BaseActivity implements AdapterView.OnItemClickListener, View.OnClickListener{
    /**
     * 标题栏返回按钮
     */
     ...
     * 选择客户业务类
     */
    private TmsOrderPartyActivityBiz mBiz;
    /**
     * 客户列表 ListView
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tmsorder_party);
        initData();
        initView();
        initListener();
        getCustomerData();
    ...
    private void initData() {
        try {
            mBiz = new TmsOrderPartyActivityBiz(this);
        } catch (Exception e) {
    ...
    private void initView() {
        try {
            ...
            mPartyListAdapter = new PartyListAdapter(TmsOrderPartyActivity.this, null);
    ...
    private void showDwonLoadingDialog() {
        if (mLoadingDialog == null) {
            mLoadingDialog = new MyLoadingDialog(TmsOrderPartyActivity.this);
        }
    ...
    private void createAddressDialog() {
        try {
            AlertDialog.Builder builder = new AlertDialog.Builder(TmsOrderPartyActivity.this);
            ...
            mCustomerAddressAdapter = new AddressListAdapter(TmsOrderPartyActivity.this, null);
    ...
    private void jumpToMakeOrderActivity(Address address) {
        try {
            ...
            intent1.putExtra(EXTRAConstants.ORDER_PARTY_ID,party.getIDX());
            intent1.putExtra(EXTRAConstants.ORDER_PARTY_NAME, party.getPARTY_NAME());
            intent1.putExtra(EXTRAConstants.ORDER_PARTY_ADDRESS_IDX, address.getIDX());
            intent1.putExtra(EXTRAConstants.ORDER_ADDRESS_INFORMATION, address.getADDRESS_INFO());
            TmsOrderPartyActivity.this.setResult(RESULT_OK,intent1);
            finish();
        } catch (Exception e) {
            ExceptionUtil.handlerException(e);
        }
