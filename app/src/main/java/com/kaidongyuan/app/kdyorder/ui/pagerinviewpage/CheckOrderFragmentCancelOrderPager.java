 ...
 * 已取消订单界面
 */
public class CheckOrderFragmentCancelOrderPager implements PagerNecessaryInterface, AdapterView.OnItemClickListener, View.OnClickListener {
     ...
     * 已取消订单界面业务类
     */
    private CheckOrderFragmentCancelOrderPagerBiz mBiz;
    ...
    public CheckOrderFragmentCancelOrderPager(Context context) {
        try {
    ...
    private void init() {
        try {
            mBiz = new CheckOrderFragmentCancelOrderPagerBiz(this);
        } catch (Exception e) {
            ExceptionUtil.handlerException(e);
        }
    }
