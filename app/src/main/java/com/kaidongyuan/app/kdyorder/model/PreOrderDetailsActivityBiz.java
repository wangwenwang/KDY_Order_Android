 ...
 * 订单详情界面
 */
public class PreOrderDetailsActivityBiz {

    private PreOrderDetailsActivity mActivity;
    ...
    public PreOrderDetailsActivityBiz(PreOrderDetailsActivity activity) {
        ...
        try {
            StringRequest request=new StringRequest(Request.Method.POST, URLCostant.OrderCancel, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    Logger.w(PreOrderDetailsActivityBiz.this.getClass() + "getOrderDetailsDataSuccess:" + response);
                ...
                public void onErrorResponse(VolleyError error) {
                    Logger.w(PreOrderDetailsActivityBiz.this.getClass() + "getOrderDetailsDataError:" + error.toString());
    ...
    public boolean getOrderDetailsData(final String orderId) {
        try {
            StringRequest request = new StringRequest(Request.Method.POST, URLCostant.GetOrderPlanDetail, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    Logger.w(PreOrderDetailsActivityBiz.this.getClass() + "getOrderDetailsDataSuccess:" + response);
    ...
    private void getOrderDetailsDataSuccess(String response) {
        try {
            ...
            if (type == 1) {
                ...
                mOrder = JSON.parseObject(jo.getString("order"), PreOrder.class);
     ...
     * @return 订单详情
     */
    public PreOrder getOrderDetails() {
        return mOrder;
    }
