...
public class ProductStockListAdapter extends BaseAdapter{
    ...
    public ProductStockListAdapter( Context mContext) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView==null){
            convertView= LayoutInflater.from(mContext).inflate(R.layout.item_productstock_detail,parent,false);
    ...
    private class ViewHolder{
        TextView tv_stock_no,tv_stock_qty,tv_product_date;
    }
}
