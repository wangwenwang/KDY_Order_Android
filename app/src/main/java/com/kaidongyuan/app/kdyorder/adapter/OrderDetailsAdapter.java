...
public class OrderDetailsAdapter extends BaseAdapter {
    ...
    public OrderDetailsAdapter(Context context, List<OrderDetails> detailses) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String orderQTY = CheckStringEmptyUtil.checkStringIsEmptyWithNoSet(orderDetail.getORDER_QTY() + orderDetail.getORDER_UOM());
        holder.tv_order_qty.setText(orderQTY);

        String orderWeight = CheckStringEmptyUtil.checkStringIsEmptyWithNoSet(orderDetail.getORDER_WEIGHT());
        ...
        String orderVolume = CheckStringEmptyUtil.checkStringIsEmptyWithNoSet(orderDetail.getORDER_VOLUME());
        holder.tv_order_volume.setText(orderVolume + "m³");

        String totalPrice = CheckStringEmptyUtil.checkStringIsEmptyWithNoSet(String.valueOf(orderDetail.getORDER_QTY() * orderDetail.getACT_PRICE()));
