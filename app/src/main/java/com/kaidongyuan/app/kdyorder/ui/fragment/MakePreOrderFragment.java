...
import com.kaidongyuan.app.kdyorder.model.MakePreOrderFragmentBiz;
 ...
 * 主页 Fragment
 */
public class MakePreOrderFragment extends BaseFragment implements AdapterView.OnItemClickListener, View.OnClickListener {
     ...
     * 下单业务类
     */
    private MakePreOrderFragmentBiz mBiz;
    /**
     * 客户列表 ListView
     */
    ...
    private void initData() {
        try {
            mBiz = new MakePreOrderFragmentBiz(this);
        } catch (Exception e) {
            ExceptionUtil.handlerException(e);
        }
    }
    ...
    private void jumpToMakeOrderActivity(Address address) {
        try {
            Intent makeOrderIntent = new Intent(getActivity(), MakePreOrderActivity.class);
