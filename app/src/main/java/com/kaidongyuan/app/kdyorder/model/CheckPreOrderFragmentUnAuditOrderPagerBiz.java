 ...
 * 在途订单界面的业务类
 */
public class CheckPreOrderFragmentUnAuditOrderPagerBiz {

    private CheckPreOrderFragmentUnAuditOrderPage mPager;
    ...
    public CheckPreOrderFragmentUnAuditOrderPagerBiz(CheckPreOrderFragmentUnAuditOrderPage page) {
        try {
            this.mPager = page;
        ...
        try {
            StringRequest request = new StringRequest(Request.Method.POST, URLCostant.GetOrderPlanList, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    Logger.w(CheckPreOrderFragmentUnAuditOrderPagerBiz.this.getClass() + ".getOrdersDataSuccess:" + response);
                    getOrderDataSuccess(response);
                }
            }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    Logger.w(CheckPreOrderFragmentUnAuditOrderPagerBiz.this.getClass() + ".getOrdersDataError:" + error.toString());
