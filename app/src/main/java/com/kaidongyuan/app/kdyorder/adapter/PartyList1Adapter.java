 ...
 * 客户列表的listview适配器
 */
public class PartyList1Adapter extends BaseAdapter {

	private Context mContext;
	List<Party> partyList;

	public PartyList1Adapter(Context mContext, List<Party> partyList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null){
			convertView = LayoutInflater.from(mContext).inflate(R.layout.item_party1_list, null);
