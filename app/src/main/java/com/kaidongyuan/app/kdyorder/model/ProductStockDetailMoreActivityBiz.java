...
import com.kaidongyuan.app.kdyorder.ui.activity.ProductStockDetailMoreActivity;
 ...
 */
public class ProductStockDetailMoreActivityBiz {
    private ProductStockDetailMoreActivity mActivity;
    ...
    public ProductStockDetailMoreActivityBiz(ProductStockDetailMoreActivity mActivity) {
    ...
    public boolean getProductStocksData() {
        try {
            StringRequest request = new StringRequest(Request.Method.POST, URLCostant.GetNewStockNoList, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    Logger.w(ProductStockDetailMoreActivityBiz.this.getClass() + ".getProductDataSuccess:" + response);
                    getProductStocksDataSuccess(response);
                }
            }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    Logger.w(ProductStockDetailMoreActivityBiz.this.getClass() + ".getProductError:" + error.toString());
