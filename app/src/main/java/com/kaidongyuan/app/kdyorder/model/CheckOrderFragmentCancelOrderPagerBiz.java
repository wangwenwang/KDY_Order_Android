 ...
 * 在途订单界面的业务类
 */
public class CheckOrderFragmentCancelOrderPagerBiz {

    private CheckOrderFragmentCancelOrderPager mPager;
    ...
    public CheckOrderFragmentCancelOrderPagerBiz(CheckOrderFragmentCancelOrderPager page) {
        try {
            this.mPager = page;
        ...
        try {
            StringRequest request = new StringRequest(Request.Method.POST, URLCostant.GET_ORDER_LIST, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    Logger.w(CheckOrderFragmentCancelOrderPagerBiz.this.getClass() + ".getOrderDataSuccess:" + response);
                    getOrderDataSuccess(response);
                }
            }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    Logger.w(CheckOrderFragmentCancelOrderPagerBiz.this.getClass() + ".getOrderDataError:" + error.toString());
