 ...
 * 下单界面业务类
 */
public class MakePreOrderActivityBiz {

    private MakePreOrderActivity mActivity;
    ...
    public MakePreOrderActivityBiz(MakePreOrderActivity activity) {
        ...
        try {
            StringRequest request = new StringRequest(Request.Method.POST, URLCostant.GET_PRODUCT_TYPE, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    Logger.w(MakePreOrderActivityBiz.this.getClass() + "getProductTypesDataSuccess:" + response);
                    getProductTypesDataSuccess(response);
                }
            }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    Logger.w(MakePreOrderActivityBiz.this.getClass() + "getProductTypesDataVolleyError:" + error.toString());
    ...
    public boolean getProductsData(final String mOrderPartyId, final String mOrderAddressIdx, int index) {
        try {
            ...
            StringRequest request = new StringRequest(Request.Method.POST, URLCostant.GET_PRDUCT_LIST_TYPE, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    Logger.w(MakePreOrderActivityBiz.this.getClass() + "getProductsDataSuccess:" + response);
                    getProductsDataSuccess(response);
                }
            }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    Logger.w(MakePreOrderActivityBiz.this.getClass() + "getProductsDataVolleyError:" + error.toString());
                    if (NetworkUtil.isNetworkAvailable()) {
