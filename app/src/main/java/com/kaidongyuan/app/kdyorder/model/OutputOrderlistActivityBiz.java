...
import com.kaidongyuan.app.kdyorder.ui.activity.BillFeeListActivity;
 ...
 */
public class OutputOrderlistActivityBiz {

    private OutputOrderListActivity mActivity;
    /**
     * 获取客户列表的网络请求标记
     */
    ...
    public OutputOrderlistActivityBiz(OutputOrderListActivity activity, String PARTY_IDX) {
        try {
    ...
    private boolean GetOutPutOrders() {
        ...
        try {
            StringRequest request = new StringRequest(Request.Method.POST, URLCostant.GetOupputList, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    Logger.w(OutputOrderlistActivityBiz.this.getClass() + ".GetOutPutOrders:" + response);
                    GetOutPutOrdersSuccess(response);
                }
            }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    Logger.w(OutputOrderlistActivityBiz.this.getClass() + ".GetOutPutOrders:" + error.toString());
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put("ADD_USER",mActivity.addressIdx);//客户地址id
