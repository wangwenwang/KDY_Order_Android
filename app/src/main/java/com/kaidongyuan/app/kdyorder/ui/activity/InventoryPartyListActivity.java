 ...
 */
public class InventoryPartyListActivity extends BaseActivity implements AdapterView.OnItemClickListener, View.OnClickListener{
    /**
     * 标题栏返回按钮
     */
     ...
     * 选择客户业务类
     */
    private InventoryPartyListActivityBiz mBiz;
    /**
     * 客户列表 ListView
     */
    ...
    private void initData() {
        try {
            mBiz = new InventoryPartyListActivityBiz(this);
        } catch (Exception e) {
    ...
    private void initView() {
        try {
            ...
            mPartyListAdapter = new PartyListAdapter(InventoryPartyListActivity.this, null);
    ...
    private void showDwonLoadingDialog() {
        if (mLoadingDialog == null) {
            mLoadingDialog = new MyLoadingDialog(InventoryPartyListActivity.this);
        }
    ...
    private void createAddressDialog() {
        try {
            AlertDialog.Builder builder = new AlertDialog.Builder(InventoryPartyListActivity.this);
            ...
            mCustomerAddressAdapter = new AddressListAdapter(InventoryPartyListActivity.this, null);
    ...
    private void jumpToInventoryPartyActivity(Address address) {
        try {
            Intent partyInventoryIntent = new Intent(InventoryPartyListActivity.this, PartyInventoryActivity.class);
