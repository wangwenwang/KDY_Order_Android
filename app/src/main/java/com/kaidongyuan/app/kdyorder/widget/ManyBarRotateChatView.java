 ...
 * 柱状表格图控件
 */
public class ManyBarRotateChatView extends View {
     ...
     * 表格选装的角度
     */
    private Float mChartRotationAngle = 90F;
    /**
     * 表的总长度
     */
    ...
    public ManyBarRotateChatView(Context context) {
        this(context, null);
    }

    public ManyBarRotateChatView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ManyBarRotateChatView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.mContext = context;
        this.mBottomTextSize = dpToPx(context, 15);
        this.mLeftTextSize = dpToPx(context, 8);
        this.mDataTopTextSize = dpToPx(context, 8);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.rotate(mChartRotationAngle);
     ...
     */
    public ManyBarRotateChatView setData(List<Map<String, String>> data) {
        try {
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setDataBarColors(int[] dataBarColors) {
        try {
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setDataNames(Map<String, String> dataNames) {
        try {
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setDataBackgroundColor(int dataBackgroundColor) {
        try {
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setLeftTextColor(int leftTextColor) {
        try {
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setBottomTextColor(int bottomTextColor) {
        try {
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setTitleColor(int titleColor) {
        try {
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setLineColor(int lineColor) {
        try {
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setBottomTextSize(int bottomTextSize) {
        try {
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setLeftTextSize(int leftTextSize) {
        try {
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setDataTopTextSize(int dataTopTextSize) {
        try {
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setTitleTextSize(int titleTextSize) {
        try {
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setDataCompany(String dataCompany) {
        try {
            if (dataCompany == null) {
                return this;
            }
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setDataTitle(String dataTitle) {
        try {
            mDataTitle = dataTitle == null ? "" : dataTitle;
            this.invalidate();
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setSpanBottomText(int spanBottomText) {
        try {
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setSpanDataTopText(int spanDataTopText) {
        try {
     ...
     * @return 对象本身
     */
    public ManyBarRotateChatView setCharBarWidth(int charBarWidth) {
        try {
     ...
     * 设置表格选择的角度
     *
     * @param chartRotationAngle 旋转角度 Float 类型
     * @return 对象本身
     */
    public ManyBarRotateChatView setChartRotationAngle(Float chartRotationAngle) {
        try {
            this.mChartRotationAngle = chartRotationAngle;
            this.invalidate();
        } catch (Exception e) {
            e.printStackTrace();
        }
