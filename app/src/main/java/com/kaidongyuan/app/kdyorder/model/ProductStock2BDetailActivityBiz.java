...
import com.kaidongyuan.app.kdyorder.ui.activity.ProductStock2BDetailActivity;
 ...
 */
public class ProductStock2BDetailActivityBiz {
    private ProductStock2BDetailActivity mActivity;
    ...
    public ProductStock2BDetailActivityBiz(ProductStock2BDetailActivity mActivity) {
        this.mActivity = mActivity;
        productStocks=new ArrayList<>();
    }

    public List<ProductStock2B> getProductStocks() {
    ...
    public boolean getProductStocksData() {
        try {
            StringRequest request = new StringRequest(Request.Method.POST, URLCostant.GetWmsProductSum, new Response.Listener<String>() {
                @Override
                public void onResponse(String response) {
                    Logger.w(ProductStock2BDetailActivityBiz.this.getClass() + ".getProductDataSuccess:" + response);
                    getProductStocksDataSuccess(response);
                }
            }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    Logger.w(ProductStock2BDetailActivityBiz.this.getClass() + ".getProductError:" + error.toString());
    ...
    private void getProductStocksDataSuccess(String response) {
        try {
            ...
            if (type == 1) {
                ...
                productStocks = JSON.parseArray(jo.getString("TmsList"), ProductStock2B.class);
