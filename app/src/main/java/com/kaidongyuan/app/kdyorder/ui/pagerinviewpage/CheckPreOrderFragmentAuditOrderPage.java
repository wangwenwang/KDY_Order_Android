...
import com.kaidongyuan.app.kdyorder.model.CheckPreOrderFragmentAuditOrderPagerBiz;
 ...
 * 已完成订单界面
 */
public class CheckPreOrderFragmentAuditOrderPage implements PagerNecessaryInterface, AdapterView.OnItemClickListener, View.OnClickListener {
     ...
     * 已完成订单界面业务类
     */
    private CheckPreOrderFragmentAuditOrderPagerBiz mBiz;
    ...
    public CheckPreOrderFragmentAuditOrderPage(Context context) {
        try {
    ...
    private void init() {
        try {
            mBiz = new CheckPreOrderFragmentAuditOrderPagerBiz(this);
        } catch (Exception e) {
            ExceptionUtil.handlerException(e);
        }
    }
